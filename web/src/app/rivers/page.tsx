...
import { rivers } from "@/lib/mock-data";
import type { DifficultyClass } from "@/lib/mock-data";
import RiverCard from "@/components/RiverCard";

const ALL_STATES = Array.from(new Set(rivers.map((r) => r.state))).sort();
const ALL_DIFFICULTIES: DifficultyClass[] = ["I-II", "III", "III-IV", "IV", "IV-V", "V", "V+"];
...
export default function RiversPage() {
  ...
  }, [search, stateFilter, difficultyFilter]);
